...
$query = mysqli_query($conexion, "SELECT * FROM clientes WHERE usuario = '$usuario'");
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 d-flex align-items-center justify-content-center">
                                ...
                                <strong><?php echo $row['cliente']?></strong></p>
                            </div>
                        </div>
                        <br>
                        <br>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 d-flex align-items-center justify-content-center">
                                <p><?php echo $row['paquete']?><br>
                                Desde: <?php echo $row['fechaAlta']?></p>
                            </div>
                        </div>
                        <br>
                        <br>
